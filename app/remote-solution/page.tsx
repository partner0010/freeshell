        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
              ...
              <h3 className="text-lg font-semibold mb-2 text-white">서버 관리</h3>
            ...
            <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
              ...
              <h3 className="text-lg font-semibold mb-2 text-white">원격 모니터링</h3>
              <p className="text-sm text-gray-300">
                실시간 시스템 상태 모니터링
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
              ...
              <h3 className="text-lg font-semibold mb-2 text-white">네트워크 관리</h3>
              <p className="text-sm text-gray-300">
                네트워크 연결 및 트래픽 관리
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
              ...
              <h3 className="text-lg font-semibold mb-2 text-white">설정 관리</h3>
              <p className="text-sm text-gray-300">
                원격 설정 및 구성 관리
              </p>
            </div>
          ...
          <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
            <h2 className="text-2xl font-bold mb-6 text-white">서비스 상태</h2>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">{service.location}</div>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-400">가동률: {service.uptime}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
              <h3 className="text-xl font-semibold mb-4 text-white">주요 기능</h3>
            ...
            <div className="bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-700">
              <h3 className="text-xl font-semibold mb-4 text-white">서비스 정보</h3>
              <ul className="space-y-2 text-gray-300">
                <li>• 글로벌 CDN 네트워크</li>
                <li>• 다중 지역 백업</li>
                <li>• 고가용성 아키텍처</li>
