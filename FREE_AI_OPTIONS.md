...
현재 시스템은 **OpenAI API**에 의존하고 있으며, 이것은 **유료 서비스**입니다. 하지만 완전히 무료로 사용할 수 있는 대안들이 있습니다!

## 🆓 무료 옵션

### 옵션 1: Hugging Face Inference API (무료)
...
현재 시스템은 OpenAI API를 기본으로 사용하지만, 무료 옵션으로 전환하거나 추가할 수 있습니다!
