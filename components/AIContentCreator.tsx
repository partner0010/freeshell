    ...
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600">
          유튜브, 블로그, SNS 콘텐츠를 AI로 즉시 생성하고 수익화하세요
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <h3 className="text-xl font-bold mb-6 text-gray-900">콘텐츠 설정</h3>
            ...
            <div className="grid grid-cols-2 gap-3">
              {contentTypes.map((type) => {
                ...
                return (
                  ...
                  >
                    <Icon className={`w-5 h-5 mb-2 ${contentType === type.id ? 'text-primary' : 'text-gray-400'}`} />
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-primary text-gray-900"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-4 bg-primary text-white rounded-xl font-semibold text-lg hover:bg-primary-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-gray-900">생성된 콘텐츠</h3>
            {result && (
