...
def build_plan(intent: Dict[str, Any], request: Dict[str, Any]) -> List[Task]:
    ...
    plans = {
        ...
        'character': _build_character_plan(parameters),
        'spatial': _build_spatial_plan(parameters)
    }
...
def _build_character_plan(parameters: Dict[str, Any]) -> List[Task]:
    """캐릭터 생성 Plan"""
    return [
        Task(
...
def _build_spatial_plan(parameters: Dict[str, Any]) -> List[Task]:
    """공간 생성 Plan"""
    return [
        Task(
            name="create_space",
