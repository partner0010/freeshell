...
**참고:** `netlify.toml` 파일이 프로젝트 루트에 있으면 자동으로 인식됩니다.
...
### 3. Domain Management ⚠️ (중요!)

**확인 위치:**
- `https://app.netlify.com/projects/imaginative-fudge-4eb324/domains`

**⚠️ 필수 작업:**
1. **"Add a domain" 버튼 클릭**
2. **`freeshell.co.kr` 입력 후 "Verify" 클릭**
3. **`www.freeshell.co.kr` 입력 후 "Verify" 클릭**
...
### 로컬 파일 ✅
- [x] netlify.toml 파일 설정 완료 (프로젝트 루트)
- [x] package.json build 스크립트 설정 완료
- [x] prisma/schema.prisma 파일 존재 (프로젝트 루트)

### Netlify 대시보드 ⚠️
- [ ] Build command 확인 (또는 netlify.toml 자동 인식 확인)
